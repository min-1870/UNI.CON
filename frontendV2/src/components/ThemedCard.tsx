...
export type ThemedViewProps = ViewProps & {
  type?: 'default' | 'defaultViewed' | 'defaultGray' | 'detail'; // Optional prop to specify the type of card
...
export default function ThemedCard({
  ...
  const DEFAULT_GRAY_CARD_BG = useThemeColor({}, 'DEFAULT_GRAY_BACKGROUND');

  return <View style={[{ 
      backgroundColor: type == 'defaultViewed' 
        ? DEFAULT_VIEWED_CARD_BG 
        : type == 'defaultGray' 
        ? DEFAULT_GRAY_CARD_BG 
        : DEFAULT_CARD_BG,
