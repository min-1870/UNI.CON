...
class articleModificationTests(APITestCase):
    ...
    def test_patch_article(self):
        ...
        patch_response = article(self.client, 'patch', updated_article, instance=False, kwargs=article_instance.id)
    ...
    def test_delete_article(self):
        ...
        # Delete the article
        delete_response = article(self.client, 'delete', instance=False, kwargs=article_instance.id)
...
class commentModificationTests(APITestCase):
    ...
    def test_post_comment(self):
        ...
        # Post a comment
        post_comment_response = post_comment(self.client, article_instance.id, instance=False)
    ...
    def test_post_nested_comment(self):
        ...
        post_nested_comment_response = post_comment(self.client, article_instance.id, post_comment_response.data['id'], instance=False)
        ...
        self.assertTrue(exist)
        nested_comment_instance = Comment.objects.get(pk=post_nested_comment_response.data['id'])
    ...
    def test_like_comment_again(self):
        ...
        # Validate the status code
        self.assertEqual(like_again_comment_response.status_code, status.HTTP_304_NOT_MODIFIED)
